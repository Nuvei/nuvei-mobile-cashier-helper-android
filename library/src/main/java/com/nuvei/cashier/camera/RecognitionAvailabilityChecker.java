...
public final class RecognitionAvailabilityChecker {
    ...
    public static class Result {
        ...
        private boolean isFailedNonBlocking() {
            ...
            return (recognitionCoreSupported == STATUS_FAILED)
        ...
        public boolean isPassed() {
            ...
            return (recognitionCoreSupported == STATUS_PASSED)
    ...
    private static class RecognitionCheckResultBuilder {
        ...
        public Result build() {
            return new Result(isBlockingCheck, recognitionCoreSupported, hasCamera, hasCameraPermission, isCameraSupported);
        }
