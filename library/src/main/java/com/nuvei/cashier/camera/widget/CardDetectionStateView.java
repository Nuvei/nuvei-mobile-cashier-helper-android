...
import com.nuvei.cashier.ndk.RecognitionConstants;
import com.nuvei.cashier.ndk.RecognitionResult;
import com.nuvei.cashier.utils.CardUtils;
...
public class CardDetectionStateView extends View {
    ...
    private void init(final Context context) {
        ...
        mCardGradientDrawable = context.getResources().getDrawable(R.drawable.frame_rect_gradient);
    ...
    private void initCornerDrawables(Context context) {
        mCornerTopLeftDrawable = (BitmapDrawable) context.getResources().getDrawable(R.drawable.card_frame_rect_corner_top_left);
    ...
    private void initLineDrawables(Context context) {
        mLineTopDrawable = (BitmapDrawable) context.getResources().getDrawable(R.drawable.card_frame_rect_line_top);
        Matrix m = new Matrix();
