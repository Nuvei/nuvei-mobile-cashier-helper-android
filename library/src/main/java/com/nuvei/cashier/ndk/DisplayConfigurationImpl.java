...
public class DisplayConfigurationImpl implements DisplayConfiguration {
    ...
    public int getNativeDisplayRotation() {
        ...
        switch (rotation) {
            case 0:
                return RecognitionConstants.WORK_AREA_ORIENTATION_PORTAIT;
            case 90:
                return RecognitionConstants.WORK_AREA_ORIENTATION_LANDSCAPE_RIGHT;
            case 180:
                return RecognitionConstants.WORK_AREA_ORIENTATION_PORTAIT_UPSIDE_DOWN;
            case 270:
                return RecognitionConstants.WORK_AREA_ORIENTATION_LANDSCAPE_LEFT;
            default:
